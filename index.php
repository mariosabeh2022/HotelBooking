    	...
    	<div class="row">
			<?php foreach($res as $r):?>
				<div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
					...
					<div class="img" style="background-image: url(<?php echo $HOTELSIMAGES ?>/<?php echo $r->image ?>);"></div>
...
<?php endforeach;?>
    ...
    <section class="ftco-section bg-light">
		...
		<div>
				...
				<?php
					$hotels="SELECT * FROM rooms WHERE status = 1";
					$stmt=$PDO->prepare($hotels);
					$stmt->execute();
...
<div class="col-lg-6">
	<div class="room-wrap d-md-flex">
		<a href="#" class="img" style="background-image: url(<?php echo $ROOMSIMAGES ?>/<?php echo $r2->image ?>);"></a>
		<div class="half left-arrow d-flex align-items-center">
			<div class="text p-4 p-xl-5 text-center">
				<p class="star mb-0"><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span></p>
				<!-- <p class="mb-0"><span class="price mr-1">$120.00</span> <span class="per">per night</span></p> -->
				<h3 class="mb-3"><a href="$APPURL./rooms-single.php?id=$id"> <?php echo $r2->name?></a></h3>
				<ul class="list-accomodation">
					<li><span>Max:</span> <?php echo $r2->num_persons ?></li>
					<li><span>Size:</span> <?php echo $r2->size ?> m2</li>
					<li><span>View:</span> <?php echo $r2->view ?></li>
					<li><span>Bed:</span> <?php echo $r2->num_beds ?></li>
				</ul>
				<p class="pt-1"><a href="<?php echo $APPURL ?>room-single.php?id=<?php echo $r2->id ?>" class="btn-custom px-3 py-2">View Room Details <span class="icon-long-arrow-right"></span></a></p>
			</div>
		</div>
	</div>
</div>
